			...
			<div>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="<%=LinkMap.STUDENT_CREATE_ACCOUNT%>">Register
							Student</a></li>
					<li><a href="<%=LinkMap.STUDENT_RESET_FORGOT_ACCOUNT%>">
						Reset Password
					</a></li>		
					<form class="navbar-form navbar-right" role="form" method="post"
						...
						<div class="form-group" style="margin-right: 20px;">
							<div class="input-group">
								...
								</span> <label class="sr-only" for="username">Username: </label> <input
						...
						<div class="form-group" style="margin-right: 20px;">
							<div class="input-group">
								...
								</span> <label class="sr-only" for="password">Password: </label> <input
						...
						<!-- New functionality for the reset password added  -->
